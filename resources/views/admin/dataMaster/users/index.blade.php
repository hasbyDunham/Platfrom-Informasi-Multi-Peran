                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{ route('users.destroy', $user->id) }}" style="display:inline">
                            ...
                            <button type="submit" class="btn btn-danger btn-sm" disabled><i class="fa-solid fa-trash"></i>
                                Can't Delete</button>
                        </form>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{ route('users.destroy', $user->id) }}" style="display:inline">
                            ...
                            <a href="{{ route('users.destroy', $user->id) }}" class="btn btn-sm btn-danger btn-sm"
