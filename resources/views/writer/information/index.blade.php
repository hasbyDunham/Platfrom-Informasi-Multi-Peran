    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success mb-2" href="{{ route('writer.information.create') }}"><i class="fa fa-plus"></i> Create New
                    Information</a>
            </div>
        </div>
    </div>
        ...
        @foreach ($data as $key => $information)
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-warning btn-sm" href="{{ route('information.edit', $information->id) }}"><i
