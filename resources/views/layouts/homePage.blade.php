 ...
 {{-- finish heder --}}
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" style="background-image: url('{{ asset('assets/front/img/post-slide-1.jpg') }}');">
              <div class="content">
            ...
            <div class="swiper-slide" style="background-image: url('{{ asset('assets/front/img/post-slide-2.jpg') }}');">
              <div class="content">
            ...
            <div class="swiper-slide" style="background-image: url('{{ asset('assets/front/img/post-slide-3.jpg') }}');">
              <div class="content">
            ...
            <div class="swiper-slide" style="background-image: url('{{ asset('assets/front/img/post-slide-4.jpg') }}');">
              <div class="content">
          ...
          <div class="col-md-9">
            ...
            <div class="d-lg-flex post-entry">
              <a href="blog-details.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                <img src="{{ asset('assets/front/img/post-landscape-6.jpg') }}" alt="" class="img-fluid">
              </a>
              <div>
                ...
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="{{ asset('assets/front/img/person-2.jpg') }}" alt="" class="img-fluid"></div>
                  <div class="name">
          ...
          <div class="col-md-9 order-md-2">
            ...
            <div class="d-lg-flex post-entry">
              <a href="blog-details.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                <img src="{{ asset('assets/front/img/post-landscape-3.jpg') }}" alt="" class="img-fluid">
              </a>
              <div>
                <div class="post-meta"><span class="date">Business</span> <span class="mx-1">•</span> <span>Jul 5th '22</span></div>
                <h3><a href="blog-details.html">What is the son of Football Coach John Gruden, Deuce Gruden doing Now?</a></h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat exercitationem magni voluptates dolore. Tenetur fugiat voluptates quas, nobis error deserunt aliquam temporibus sapiente, laudantium dolorum itaque libero eos deleniti?</p>
                <div class="d-flex align-items-center author">
                  <div class="photo"><img src="{{ asset('assets/front/img/person-4.jpg') }}" alt="" class="img-fluid"></div>
                  <div class="name">
                    <h3 class="m-0 p-0">Wade Warren</h3>
                  </div>
                </div>
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <div class="post-list lg">
              ...
              <div class="d-flex align-items-center author">
                <div class="photo"><img src="{{ asset('assets/front/img/person-7.jpg') }}" alt="" class="img-fluid"></div>
                <div class="name">
          ...
          <div class="col-lg-8">
            <div class="row g-5">
              <div class="col-lg-4 border-start custom-border">
                ...
                <div class="post-list">
                  <a href="blog-details.html"><img src="{{ asset('assets/front/img/post-landscape-4.jpg') }}" alt="" class="img-fluid"></a>
  ...
  <footer id="footer" class="footer dark-background">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="{{ url('/') }}" class="logo d-flex align-items-center">
            <span class="sitename">WartaBalarea</span>
          </a>
          ...
          <div class="social-links d-flex mt-4">
            <a href="https://github.com/MardianSuparman/Platfrom-Informasi-Multi-Peran"><i class="bi bi-github"></i></a>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">WartaBalarea</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
